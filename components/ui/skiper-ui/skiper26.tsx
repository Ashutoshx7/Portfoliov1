...
export const ThemeToggleButton = ({
  ...
  return (
    <button
      type="button"
      className={cn(
        "size-9 flex items-center justify-center cursor-pointer rounded-full bg-transparent p-0 transition-all duration-300 active:scale-95",
        className,
      )}
      onClick={toggleTheme}
    ...
    >
      ...
      >
        ...
        >
          ...
          />
          <path
            d="M4.22 4.22L5.64 5.64M18.36 18.36L19.78 19.78M19.78 4.22L18.36 5.64M5.64 18.36L4.22 19.78"
            stroke="currentColor"
            strokeWidth="2"
            strokeLinecap="round"
          />
